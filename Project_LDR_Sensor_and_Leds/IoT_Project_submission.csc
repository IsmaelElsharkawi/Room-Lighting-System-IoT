...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <description>skymote</description>
      <source EXPORT="discard">[CONTIKI_DIR]/examples/ipv6/sky-websense/sky-websense.c</source>
      <commands EXPORT="discard">make sky-websense.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/ipv6/sky-websense/sky-websense.sky</firmware>
      <moteinterface>se.sics.cooja.interfaces.Position</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>62.74122972398341</x>
        <y>35.29569874671668</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>10.682002151452648 0.0 0.0 10.682002151452648 -453.2019508963756 -193.02872994945216</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
